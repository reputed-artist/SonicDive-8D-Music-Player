...
class MusicPlayer(QMainWindow):
    ...
    def init_ui(self):
        ...
        def create_transport_btn(text, tooltip=""):
            btn = QPushButton(text)
            btn.setToolTip(tooltip)
            btn.setFixedSize(46, 46)
            btn.setStyleSheet("""
        ...
        self.btn_prev = create_transport_btn("⏮", "Previous")
        self.btn_play = create_transport_btn("▶", "Play/Pause")
        self.btn_next = create_transport_btn("⏭", "Next")
        # self.btn_stop = create_transport_btn("⏹", "Stop")
