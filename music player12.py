...
class MusicPlayer(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.table.setColumnWidth(0, 260)  # Track column
        self.table.setColumnWidth(1, 180)   # Duration column
        ...
        self.spectrum.setMaximumHeight(420)
    ...
    def load_folder(self):
        ...
        for f in os.listdir(folder):
            if f.lower().endswith((".mp3", ".wav", ".flac", ".ogg", ".m4a")):
                ...
                # Track name with gray disc icon - CHANGED from ● to 💿
        ...
        if 0 <= row < len(self.files):
            ...
            for i in range(self.table.rowCount()):
                ...
                if track_item:
                    ...
                    # Remove any color emoji and set back to CD emoji - CHANGED from ● to 💿
    ...
    def stop(self):
        ...
        # Reset all tracks to CD emoji - CHANGED from ● to 💿
